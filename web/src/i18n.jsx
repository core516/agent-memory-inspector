...
const DICT = {
  en: {
    ...
    'scan.title': 'Scanning memory…',
    'scan.found': '{n} found',
    'scan.walking': 'Walking the filesystem…',
    'scan.doneTitle': 'Scan complete',
    'scan.complete': 'done — {n} memories. Press ✕ to close.',
    'scan.close': 'Close',
    'lang.switch': '中文',
    ...
    'sidebar.lastScan': 'Last scan: {time}',
    'sidebar.neverScannedShort': 'Not scanned yet',
    'sidebar.neverScanned': 'No scan results yet. Run a scan to read your agent memory.',
    'row.index': 'INDEX',
  ...
  zh: {
    ...
    'scan.walking': '正在遍历文件…',
    'scan.doneTitle': '扫描完成',
    'scan.complete': '完成 —— 共 {n} 条记忆。点击 ✕ 关闭。',
    'scan.close': '关闭',
    'lang.switch': 'EN',
    ...
    'sidebar.lastScan': '上次扫描：{time}',
    'sidebar.neverScannedShort': '尚未扫描',
    'sidebar.neverScanned': '还没有扫描结果。点击重新扫描以读取智能体记忆。',
    'row.index': '索引',
    'detail.loading': '加载中…',
    'detail.edit': '✎ 编辑',
    'detail.delete': '🗑 删除',
